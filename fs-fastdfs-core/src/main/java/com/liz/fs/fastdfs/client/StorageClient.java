...
package com.liz.fs.fastdfs.client;

import com.liz.fs.fastdfs.common.Base64;
import com.liz.fs.fastdfs.common.MyException;
...
public class StorageClient {
  ...
  public String[] upload_file(String group_name, byte[] file_buff,String master_filename,String prefix_name,
                              String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
    return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_FILE, group_name, master_filename, prefix_name, file_ext_name,
            file_buff.length, new UploadBuff(file_buff, 0, file_buff.length), meta_list);
  }
